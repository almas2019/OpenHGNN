BEST_CONFIGS = {
    "node_classification": {
        ...
        'GTN': {
            ...
            'imdb4GTN': {
                'lr': 0.01, 'hidden_dim': 64, 'num_layers': 2, 'num_channels': 8, 'adaptive_lr_flag': True,
                'dropout': 0.1
            },
            'dblp4GTN': {
        ...
        'fastGTN': {
            'general': {'lr': 0.005, 'weight_decay': 0.001, 'hidden_dim': 64, 'max_epoch': 50, 'patience': 20,
                        'norm_emd_flag': True, 'mini_batch_flag': False},
            'tcell_fib': {
                'lr': 0.0001,'num_layers': 3, 'num_channels': 2, 'adaptive_lr_flag': True,
            },
            'tcell_fib2': {
                'lr': 0.001,'num_layers': 3, 'num_channels': 2, 'adaptive_lr_flag': True,
            },  
            'tcell_fib3': {
            ...
            'imdb4GTN': {
                'lr': 0.005, 'num_layers': 4, 'dropout': 0.3, 'num_channels': 2, 'hidden_dim': 64,
