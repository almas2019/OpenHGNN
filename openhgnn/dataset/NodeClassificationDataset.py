...
class HIN_NodeClassification(NodeClassificationDataset):
    ...
    def load_HIN(self, name_dataset):
        ...
        elif name_dataset == 'tcell_fib':
            data_path = '/home/almas/projects/def-gregorys/almas/synthetic_data_gnn/data/crc_data/cytospace_medusa/graph_het_subsampled_tcell_fib.bin'
            category = 'Tcell'
            num_classes = 2
            g, _ = load_graphs(data_path)
            g = g[0].long()
        ...
        elif name_dataset == 'tcell_fib2':
            data_path = '/home/almas/projects/def-gregorys/almas/synthetic_data_gnn/data/crc_data/cytospace_medusa/graph_het_subsampled_tcell_fib2.bin'
            category = 'Tcell'
            num_classes = 2
            g, _ = load_graphs(data_path)
            g = g[0].long()
        ...
        elif name_dataset == 'tcell_fib3':
            data_path = '/home/almas/projects/def-gregorys/almas/synthetic_data_gnn/data/crc_data/cytospace_medusa/graph_het_subsampled_tcell_fib3.bin'
            category = 'Tcell'
            num_classes = 2
            g, _ = load_graphs(data_path)
            g = g[0].long()
