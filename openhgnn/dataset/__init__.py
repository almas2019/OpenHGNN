...
def build_dataset(dataset, task, *args, **kwargs):
    ...
    if dataset in ['aifb', 'mutag', 'bgs', 'am']:
        _dataset = 'rdf_' + task
                     ...
                     'Book-Crossing', 'amazon4SLICE', 'MTWM', 'HNE-PubMed', 'HGBl-ACM', 'HGBl-DBLP', 'HGBl-IMDB','amazon', 'yelp4HGSL','tcell_fib','tcell_fib2','tcell_fib3','tcell_fib4','tcell_fib5']:
        _dataset = 'hin_' + task
        ...
        _dataset = 'demo_' + task
    elif dataset == 'tcell_fib':
        _dataset = 'tcell_fib_' + task
    elif dataset == 'mag':
