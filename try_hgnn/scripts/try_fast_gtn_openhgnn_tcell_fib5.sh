...
CUDA_LAUNCH_BLOCKING=1 python main.py -m fastGTN -t node_classification -d tcell_fib5 -g 0 --use_best_config --early_stopping False # will save model if early stopping is true, need to figure out what to do if early stopping is false
